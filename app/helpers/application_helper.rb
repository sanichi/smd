module ApplicationHelper
  PICTURES = [
    ...
    [1, 1, "bargemon_provence",                  "600x400", "42x30", "mm", "a", 320, "Bargemon, Provence"],
    [1, 1, "french_village",                     "600x400", "42x29", "mm", "a", 250, "French Village"],
    [1, 1, "amalfi_houses",                      "400x600", "29x42", "mm", "a", 320, "Amalfi Houses"],
    [1, 1, "a_day_at_the_beach",                 "600x600", "37x39", "mm", "a", 380, "A Day at the Beach"], # used to be la_dolce_vita
    ...
    [2, 1, "across_the_moorfoots",               "600x300", "69x48", "mm", "a", 240, "Across the Moorfoots"],
    [2, 1, "the_moorfoots",                      "600x235", "00x00", "mm", "s", nil, "The Moorfoots"],
    [2, 1, "derbyshire_dales",                   "600x440", "39x27", "mm", "a", nil, "Across the Fields"],
    [2, 1, "into_the_blue_rocky_foreshore",      "600x420", "00x00", "mm", "a", 375, "Into the Blue"],
    ...
    [2, 1, "the_singing_sands",                  "800x800", "00x00", "mm", "a", 250, "The Singing Sands"],
