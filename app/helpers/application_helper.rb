module ApplicationHelper
  ...
  # {g: 1, r: 1, s: 0, src: "cinque_terre",                       size: "600x809", type: "mm", alt: "Cinque Terre"},
    ...
    {g: 1, r: 1, s: 1, src: "positano",                           size: "900x582", type: "mm", alt: "Positano"},
    {g: 1, r: 1, s: 1, src: "olive_trees_provence",               size: "900x560", type: "mm", alt: "Olive Trees, Provence"},
    {g: 1, r: 1, s: 1, src: "washing_day_venice",                 size: "900x680", type: "mm", alt: "Washing Day, Venice"},
  ...
  # {g: 2, r: 1, s: 0, src: "golden_glow_skye",                   size: "889x600", type: "mm", alt: "Golden Glow, Skye"},
    {g: 2, r: 1, s: 0, src: "poppy_field_east_lothian",           size: "800x548", type: "mm", alt: "Poppy Field, East Lothian"},
    {g: 2, r: 1, s: 0, src: "poppy_field_fife",                   size: "800x500", type: "mm", alt: "Poppy Field, Fife"},
    {g: 2, r: 1, s: 1, src: "the_singing_sands",                  size: "800x800", type: "mm", alt: "The Singing Sands"},
    {g: 2, r: 2, s: 1, src: "north_berwick_law",                  size: "800x520", type: "mm", alt: "North Berwick Law"},
  ...
  # {g: 2, r: 2, s: 1, src: "staffin_bay_skye",                   size: "600x345", type: "mm", alt: "Staffin Bay Skye"},
    ...
    {g: 2, r: 2, s: 1, src: "rocky_foreshore",                    size: "800x400", type: "mm", alt: "Rocky Foreshore"},
    {g: 2, r: 2, s: 0, src: "dark_trees",                         size: "800x550", type: "mm", alt: "Dark Trees"},
