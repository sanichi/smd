module ApplicationHelper
  PICTURES = [
    [1, 1, "moonlight_over_venice",              "900x350", "60x31", "mm", "a", nil, "Moonlight Over Venice"],
    [1, 1, "silence_of_villa_gioia",             "600x600", "29x29", "mm", "a", nil, "The Silence of Villa Gioia"],
    ...
    [1, 1, "midnight_in_florence",               "600x500", "39x33", "mm", "a", nil, "Midnight in Florence"],
    ...
    [1, 1, "bargemon_provence",                  "600x400", "42x30", "mm", "a", nil, "Bargemon, Provence"],
    [1, 1, "french_village",                     "600x400", "42x29", "mm", "a", nil, "French Village"],
    [1, 1, "amalfi_houses",                      "400x600", "29x42", "mm", "a", nil, "Amalfi Houses"],
    [1, 1, "a_day_at_the_beach",                 "600x600", "37x39", "mm", "a", nil, "A Day at the Beach"], # used to be la_dolce_vita
    [1, 1, "marias_cafe",                        "400x600", "15x21", "mm", "a", nil, "Maria's Cafe"],
    [1, 1, "secret_of_villa_gioia",              "530x600", "20x20", "mm", "a", nil, "The Secret of Villa Gioia"],
    ...
    [1, 1, "washing_day_venice",                 "900x680", "59x48", "mm", "a", nil, "Washing Day, Venice"],
    [1, 1, "a_bit_of_shade",                     "810x600", "38x29", "ol", "a", nil, "A Bit of Shade, Spain"],
    [2, 1, "mediterranean_gardenstown",          "600x600", "43x43", "mm", "s", nil, "Mediterranean Gardenstown"],
    [2, 1, "pennan",                             "800x380", "00x00", "mm", "s", nil, "Pennan"],
    [2, 1, "after_the_rain",                     "600x440", "56x46", "mm", "s", nil, "After the Rain"],
    [2, 1, "across_the_moorfoots",               "600x300", "69x48", "mm", "a", nil, "Across the Moorfoots"],
    [2, 1, "the_moorfoots",                      "600x235", "00x00", "mm", "s", nil, "The Moorfoots"],
    [2, 1, "derbyshire_dales",                   "600x440", "39x27", "mm", "a", nil, "Derbyshire Dales"],
    [2, 1, "into_the_blue_rocky_foreshore",      "600x420", "00x00", "mm", "a", nil, "Into the Blue, Rocky Foreshore"],
    [2, 1, "borderlands",                        "600x400", "58x42", "mm", "a", nil, "Landlines"],
    [2, 1, "glimpse_of_islands",                 "600x400", "42x33", "mm", "a", nil, "A Glimpse of Islands"],
    [2, 1, "the_sentinel",                       "600x500", "35x33", "mm", "a", nil, "The Sentinel"],
    [2, 1, "shades_of_iona",                     "600x500", "41x23", "mm", "a", nil, "Shades of Iona"],
    [2, 1, "take_me_there",                      "600x445", "42x29", "mm", "a", nil, "Take Me There"],
    [2, 1, "the_sea_sets_you_free",              "600x450", "00x00", "mm", "a", nil, "The Sea Sets You Free"],
    ...
    [2, 0, "poppy_field_east_lothian",           "800x548", "00x00", "mm", "a", nil, "Poppy Field, East Lothian"],
    [2, 0, "poppy_field_fife",                   "800x500", "00x00", "mm", "a", nil, "Poppy Field, Fife"],
    [2, 1, "the_singing_sands",                  "800x800", "00x00", "mm", "a", nil, "The Singing Sands"],
