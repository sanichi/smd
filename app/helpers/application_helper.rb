module ApplicationHelper
  PICTURES = [
    [1, 1, "amalfi_coast",                       "600x360", "mm", "Amalfi Coast"],
    [1, 1, "a_quiet_street_in_venice",           "421x600", "mm", "A Quiet Street in Venice"],
    [1, 1, "midnight_in_florence",               "600x500", "mm", "Midnight in Florence"],
    [1, 1, "cotingac_france",                    "400x600", "mm", "Cotingac, France"],
    [1, 1, "french_village",                     "400x600", "mm", "French Village"],
    [1, 1, "flamboyant_olives",                  "600x600", "mm", "Flamboyant Olives"],
    [1, 1, "bargemon_provence",                  "600x400", "mm", "Bargemon, Provence"],
    [1, 1, "provencal_village",                  "600x400", "mm", "Provencal Village"],
    [1, 1, "amalfi_houses",                      "400x600", "mm", "Amalfi Houses"],
    [1, 1, "la_dolce_vita",                      "600x600", "mm", "La Dolce Vita"],
    [1, 1, "marias_cafe",                        "400x600", "mm", "Maria's Cafe"],
    [1, 1, "secret_of_villa_gioia",              "530x600", "mm", "The Secret of Villa Gioia"],
    [1, 1, "lerici_italy",                       "600x500", "mm", "Lerici, Italy"],
    ...
    [1, 1, "a_bit_of_shade",                     "810x600", "ol", "A Bit of Shade, Spain"],
    [2, 1, "after_the_rain",                     "600x440", "mm", "After the Rain"],
    [2, 1, "across_the_moorfoots",               "600x300", "mm", "Across the Moorfoots"],
    [2, 1, "the_moorfoots",                      "600x235", "mm", "The Moorfoots"],
    [2, 1, "derbyshire_dales",                   "600x440", "mm", "Derbyshire Dales"],
    [2, 1, "into_the_blue_rocky_foreshore",      "600x420", "mm", "Into the Blue, Rocky Foreshore"],
    [2, 1, "borderlands",                        "600x400", "mm", "Borderlands"],
    [2, 1, "glimpse_of_islands",                 "600x400", "mm", "A Glimpse of Islands"],
    [2, 1, "the_sentinel",                       "600x500", "mm", "The Sentinel"],
    [2, 1, "shades_of_iona",                     "600x500", "mm", "Shades of Iona"],
    [2, 1, "take_me_there",                      "600x445", "mm", "Take Me There"],
    [2, 1, "the_sea_sets_you_free",              "600x450", "mm", "The Sea Sets You Free"],
